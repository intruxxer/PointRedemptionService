 ...
 * LogLoader
 *
 * Class untuk menyimpan log aplikasi verification
 *
...
public class LogVerifLoader {
	...
	public static Logger getLog() {
		if (LOG == null) {
		    PropertyConfigurator.configure(LogVerifLoader.class.getClassLoader().getResourceAsStream("log4j-verification.properties"));
			LOG = LoggerFactory.getLogger(LogVerifLoader.class);
