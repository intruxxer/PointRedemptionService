 ...
 * ISO8583PSWPackager
 *
 * Class packager format iso 8583 yang dikirim oleh proswitching
 *
...
//  Class ISO8583PSWPackager
public class ISO8583PSWPackager extends ISOBasePackager {
    ...
    protected ISOFieldPackager fieldPackager[] = {
        ...
        /*057*/ new IFA_LLLCHAR ( 12, "RESERVED NATIONAL"),
    ...
    public ISO8583PSWPackager(){
        super();
        setFieldPackager(fieldPackager);
    }
